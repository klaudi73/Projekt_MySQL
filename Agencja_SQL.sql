...
CREATE TABLE IF NOT EXISTS `agencja`.`produkty` (
  ...
  `prod__zaleznosc` INT(11) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `agencja`.`spotkanie_miejsce` (
  ...
  `spotkanie_miejsce__nazwa_miejsca` VARCHAR(100) NULL DEFAULT NULL,
  `spotkanie_miejsce__ulica` VARCHAR(45) NULL DEFAULT NULL,
  `spotkanie_miejsce__nr_domu` VARCHAR(45) NULL DEFAULT NULL,
  `spotkanie_miejsce__nr_lokalu` VARCHAR(45) NULL DEFAULT NULL,
  `spotkanie_miejsce__miasto` VARCHAR(45) NULL DEFAULT NULL,
  `spotkanie_miejsce__panstwo` VARCHAR(45) NULL DEFAULT NULL,
  `spotkanie_spotkanie__ID` INT(11) NOT NULL,
  PRIMARY KEY (`spotkanie_miejsce__ID`),
  INDEX `fk_spotkanie_miejsce_spotkanie1_idx` (`spotkanie_spotkanie__ID` ASC),
  CONSTRAINT `fk_spotkanie_miejsce_spotkanie1`
    FOREIGN KEY (`spotkanie_spotkanie__ID`)
    REFERENCES `agencja`.`spotkanie` (`spotkanie__ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
